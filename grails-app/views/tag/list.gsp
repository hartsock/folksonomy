...
<div id="list-tag" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="checked" title="${message(code: 'tag.checked.label', default: 'Checked')}"/>
        ...
        <g:each in="${tagInstanceList}" status="i" var="tagInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${tagInstance.id}">${fieldValue(bean: tagInstance, field: "name")}</g:link></td>

                <td><g:formatBoolean boolean="${tagInstance.checked}"/></td>
