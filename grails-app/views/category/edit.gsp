    ...
    <g:form method="post">
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="username"><g:message code="category.username.label" default="Username"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: categoryInstance, field: 'username', 'errors')}">
                        <g:textField name="username" value="${categoryInstance?.username}"/>
                    </td>
                </tr>
