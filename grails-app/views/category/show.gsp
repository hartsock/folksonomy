...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="category.username.label" default="Username"/></td>

                <td valign="top" class="value">${fieldValue(bean: categoryInstance, field: "username")}</td>
